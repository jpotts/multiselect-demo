 ...
 */
package com.ecmarchitect.alfresco.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("com.ecmarchitect.alfresco.DemoComponent");
