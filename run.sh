...
build_share() {
    ...
    yes | docker-compose -f "$COMPOSE_FILE_PATH" rm -f multiselect-demo-share
    $MVN_EXEC clean package -pl multiselect-demo-share,multiselect-demo-share-docker
}

build_acs() {
    docker-compose -f "$COMPOSE_FILE_PATH" kill multiselect-demo-acs
    yes | docker-compose -f "$COMPOSE_FILE_PATH" rm -f multiselect-demo-acs
    $MVN_EXEC clean package -pl multiselect-demo-integration-tests,multiselect-demo-platform,multiselect-demo-platform-docker
}
...
prepare_test() {
    $MVN_EXEC verify -DskipTests=true -pl multiselect-demo-platform,multiselect-demo-integration-tests,multiselect-demo-platform-docker
}

test() {
    $MVN_EXEC verify -pl multiselect-demo-platform,multiselect-demo-integration-tests
}
